...
<form action="/controllers/reg.controller.php" method="POST" class="m-auto grid gap-5 w-1/2 border p-10">
    ...
    <input class="bg-sky-400 p-3 text-white" type="submit" value="Зарегистрироваться">
</form>
<script>
